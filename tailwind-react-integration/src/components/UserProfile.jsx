...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-sm md:max-w-sm mx-auto my-10 sm:my-20 rounded-lg shadow-lg md:text-xl sm:w-24 sm:h-24 hover:shadow-xl transition-colors duration-300 ease-in-out">
      <img
